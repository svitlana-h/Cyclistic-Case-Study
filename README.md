...
**2. Introduce a monthly membership plan**  
To appeal to casual users who ride more frequently in warmer months but do not commit year-round, a monthly subscription plan can be offered. This way casual riders might subscribe for a few months when they are most active. This more flexible option would lower the barrier to entry and encourage seasonal users to become repeat customers.  
